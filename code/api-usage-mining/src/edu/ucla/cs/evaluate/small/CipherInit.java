...
public class CipherInit {
	public static void main(String[] args) {
		String raw_output = "/home/troy/research/BOA/example/Cipher.init/Small/small-sequence.txt";
		String seq = "/home/troy/research/BOA/example/Cipher.init/Small/small-output.txt";
