...
public class PrintWriterClose {
	public static void main(String[] args) {
		String raw_output = "/home/troy/research/BOA/example/PrintWriter.close/Small/small-sequence.txt";
		String seq = "/home/troy/research/BOA/example/PrintWriter.close/Small/small-output.txt";
		...
		Map<ArrayList<APISeqItem>, MutablePair<Double, Double>> patterns = PatternMiner.mine(
				raw_output, seq, queries, 0.04, size, 0.5);
