...
public class PrintWriterWrite {
	public static void main(String[] args) {
		String raw_output = "/home/troy/research/BOA/example/PrintWriter.write/Small/small-sequence.txt";
		String seq = "/home/troy/research/BOA/example/PrintWriter.write/Small/small-output.txt";
		...
		Map<ArrayList<APISeqItem>, MutablePair<Double, Double>> patterns = PatternMiner.mine(
				raw_output, seq, queries, 0.125, size, 0.5);
