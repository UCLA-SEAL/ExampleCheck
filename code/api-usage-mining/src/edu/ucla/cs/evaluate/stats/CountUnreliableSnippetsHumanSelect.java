...
public class CountUnreliableSnippetsHumanSelect {
	private HashMap<Answer, ArrayList<Violation>> violations;
	
	public CountUnreliableSnippetsHumanSelect() {
	...
	private void checkHashMapGet() {
		...
		ArrayList<APISeqItem> pattern3 = new ArrayList<APISeqItem>();
		pattern3.add(new APICall("new HashMap", "true", 0));
		pattern3.add(new APICall("get", "true", 1));
...
//		types.add("Activity");
	...
	public static void main(String[] args) {
		CountUnreliableSnippetsHumanSelect c = new CountUnreliableSnippetsHumanSelect();
		c.check();
		c.count();
	}
}
