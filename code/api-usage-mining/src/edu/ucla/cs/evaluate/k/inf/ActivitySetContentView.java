...
public class ActivitySetContentView {
	public static void main(String[] args) {
		String raw_output = "/home/troy/research/BOA/example/Activity.setContentView/INF/large-sequence.txt";
		String seq = "/home/troy/research/BOA/example/Activity.setContentView/INF/large-output.txt";
		...
		Map<ArrayList<APISeqItem>, MutablePair<Double, Double>> patterns = PatternMiner.mine(
				raw_output, seq, queries, 0.01, size, 0.3);
		for (ArrayList<APISeqItem> sp : patterns.keySet()) {
			System.out.println(sp + ":" + patterns.get(sp));
		}
		PatternMiner.sample(seq, raw_output, size, patterns, "/home/troy/research/BOA/patterns/Activity.setContentView", 10);
	}
}
