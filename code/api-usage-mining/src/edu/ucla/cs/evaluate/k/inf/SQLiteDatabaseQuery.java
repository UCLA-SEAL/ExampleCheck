...
public class SQLiteDatabaseQuery {
	public static void main(String[] args) {
		String raw_output = "/home/troy/research/BOA/example/SQLiteDatabase.query/INF/large-sequence.txt";
		String seq = "/home/troy/research/BOA/example/SQLiteDatabase.query/INF/large-output.txt";
		...
		PatternMiner.sample(seq, raw_output, size, patterns, "/home/troy/research/BOA/patterns/SQLiteDatabase.query", 10);
	}
}
