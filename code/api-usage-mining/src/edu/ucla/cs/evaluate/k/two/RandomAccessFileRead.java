...
public class RandomAccessFileRead {
	public static void main(String[] args) {
		String raw_output = "/home/troy/research/BOA/example/RandomAccessFile.read/2/large-sequence.txt";
		String seq = "/home/troy/research/BOA/example/RandomAccessFile.read/2/large-output.txt";
		...
		Map<ArrayList<APISeqItem>, MutablePair<Double, Double>> patterns = PatternMiner.mine(
				raw_output, seq, queries, 0.37, size, 0.5);
