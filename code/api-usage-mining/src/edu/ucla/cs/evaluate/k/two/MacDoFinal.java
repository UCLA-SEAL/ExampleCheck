...
public class MacDoFinal {
	public static void main(String[] args) {
		String raw_output = "/home/troy/research/BOA/example/Mac.doFinal/2/large-sequence.txt";
		String seq = "/home/troy/research/BOA/example/Mac.doFinal/2/large-output.txt";
