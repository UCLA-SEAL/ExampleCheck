...
public class CipherInit {
	public static void main(String[] args) {
		String raw_output = "/home/troy/research/BOA/example/Cipher.init/3/large-sequence.txt";
		String seq = "/home/troy/research/BOA/example/Cipher.init/3/large-output.txt";
