...
public class FileMkdirs {
	public static void main(String[] args) {
		String raw_output = "/home/troy/research/BOA/example/File.mkdir/INF/large-sequence.txt";
		String seq = "/home/troy/research/BOA/example/File.mkdir/INF/large-output.txt";
		...
		PatternMiner.sample(seq, raw_output, size, patterns, "/home/troy/research/BOA/patterns/File.mkdirs", 10);
	} 
}
