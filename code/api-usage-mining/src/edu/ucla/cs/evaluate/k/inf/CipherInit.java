...
public class CipherInit {
	public static void main(String[] args) {
		String raw_output = "/home/troy/research/BOA/example/Cipher.init/INF/large-sequence.txt";
		String seq = "/home/troy/research/BOA/example/Cipher.init/INF/large-output.txt";
		...
		PatternMiner.sample(seq, raw_output, size, patterns, "/home/troy/research/BOA/patterns/Cipher.init", 10);
	}
}
