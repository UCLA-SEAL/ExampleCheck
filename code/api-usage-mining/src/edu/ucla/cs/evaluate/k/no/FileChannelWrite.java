...
public class FileChannelWrite {
	public static void main(String[] args) {
		String raw_output = "/home/troy/research/BOA/example/FileChannel.write/NO/large-sequence.txt";
		String seq = "/home/troy/research/BOA/example/FileChannel.write/NO/large-output.txt";
		...
		Map<ArrayList<APISeqItem>, MutablePair<Double, Double>> patterns = PatternMiner.mine(
				raw_output, seq, queries, 0.38, size, 0.5);
