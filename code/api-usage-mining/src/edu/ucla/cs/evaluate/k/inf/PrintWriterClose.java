...
public class PrintWriterClose {
	public static void main(String[] args) {
		String raw_output = "/home/troy/research/BOA/example/PrintWriter.close/INF/large-sequence.txt";
		String seq = "/home/troy/research/BOA/example/PrintWriter.close/INF/large-output.txt";
		...
		Map<ArrayList<APISeqItem>, MutablePair<Double, Double>> patterns = PatternMiner.mine(
				raw_output, seq, queries, 0.17, size, 0.5);
		for (ArrayList<APISeqItem> sp : patterns.keySet()) {
			System.out.println(sp + ":" + patterns.get(sp));
		}
		PatternMiner.sample(seq, raw_output, size, patterns, "/home/troy/research/BOA/patterns/PrintWriter.close", 10);
	}
}
