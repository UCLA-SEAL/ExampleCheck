...
public class FileMkdirs {
	public static void main(String[] args) {
		String raw_output = "/home/troy/research/BOA/example/File.mkdir/2/large-sequence.txt";
		String seq = "/home/troy/research/BOA/example/File.mkdir/2/large-output.txt";
