...
public class SimpleDateFormatNew {
	public static void main(String[] args) {
		String raw_output = "/home/troy/research/BOA/example/SimpleDateFormat.new/NO/large-sequence.txt";
		String seq = "/home/troy/research/BOA/example/SimpleDateFormat.new/NO/large-output.txt";
		...
		Map<ArrayList<APISeqItem>, MutablePair<Double, Double>> patterns = PatternMiner.mine(
				raw_output, seq, queries, 0.16, size, 0.5);
