...
public class Method {
	...
	public boolean equals(Object obj) {
		...
		return this.repo.equals(that.repo) && this.file.equals(that.file)
				&& this.clazz.equals(that.clazz)
				&& this.method.equals(that.method) && this.seq.equals(that.seq);
	}
	
	@Override
	public int hashCode() {
		int hash = 17;
		hash = 37 * hash + this.repo.hashCode();
		hash = 37 * hash + this.file.hashCode();
		hash = 37 * hash + this.clazz.hashCode();
		hash = 37 * hash + this.method.hashCode();
		hash = 37 * hash + this.seq.hashCode();
		return hash;
	}
}
